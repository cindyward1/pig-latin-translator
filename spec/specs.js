describe ("pigLatinTranslator", function () {
  ...
  it("should translate all of the words in a sentence", function () {
    pigLatinTranslator("you are terribly strong and quick, don't squeal.").should.equal("ouyay areay erriblytay ongstray anday ickquay ontday ealsquay.");
  });
  it("should strip off all characters that are not letters", function () {
    pigLatinTranslator("don't").should.equal("ontday.");
  });
});
